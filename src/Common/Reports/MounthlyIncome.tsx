...
export function MounthlyIncome({ diff, trend, sx, value }: DailyIncomeProps): React.JSX.Element {
        ...
        <CardContent>
          <Stack spacing={2}>
            <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
              ...
              <Avatar sx={{ backgroundColor: '#ecdf0a', height: '56px', width: '56px' }}> {/* Blue background color */}
                <LocalAtmIcon/>
              </Avatar>
            </Stack>
            {diff ? (
