...
export function Annually({ diff, trend, sx, value }: DailyIncomeProps): React.JSX.Element {
            ...
            <CardContent>
                <Stack spacing={2}>
                    <Stack direction="row" sx={{ alignItems: 'flex-start', justifyContent: 'space-between' }} spacing={3}>
                        ...
                        <Avatar sx={{ backgroundColor: '#48e113', height: '56px', width: '56px' }}> {/* Blue background color */}
